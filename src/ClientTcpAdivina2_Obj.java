...
public class ClientTcpAdivina2_Obj extends Thread {
    ...
    private ClientTcpAdivina2_Obj(String hostname, int port) {
        try {
    ...
    private void close(Socket socket){
        ...
        try {
            ...
            Logger.getLogger(ClientTcpAdivina2_Obj.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        ClientTcpAdivina2_Obj clientTcp = new ClientTcpAdivina2_Obj(ipSrv,5558);
